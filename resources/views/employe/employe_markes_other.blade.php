...
<x-guest-width>
    <div class="max-w-7xl mx-auto p-6 lg:p-8 border-x-4 border-green-500  dark:border-indigo-500">
        <header class="flex items-center justify-between mb-4 border-b pb-4">
            <h3>{{ __('Internal Annual Transfer Application- Claculation of Marks') }}</h3>
        ...
        <div>
            <ol
                ...
                <li class="flex items-center">
                    ...
                    Calaculate <span class="hidden sm:inline-flex sm:ml-2"> Marks
                        <svg aria-hidden="true" class="w-4 h-4 ml-2 sm:ml-4" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M13 5l7 7-7 7M5 5l7 7-7 7">
        ...
        <div class="mt-2">
            ...
            {{-- @livewire('employe.markes-information',['post' =>$employe]); --}}
            @livewire('employe.markes-information-other',['post' =>$post]);
